...
import {Alert, AutoComplete, Badge, Breadcrumb, Button, Card, Carousel, Cascader, Checkbox, Collapse, ColorPicker, DatePicker, DateRangePicker, Dialog, Dropdown, Form, i18n, Icon, Input, InputNumber, Layout, Loading, Menu, Message, MessageBox, Notification, Pagination, Popover, Progress, Radio, Rate, Select, Slider, Steps, Switch, Table, Tabs, Tag, TimePicker, TimeRangePicker, TimeSelect, Tooltip, Transfer, Tree, Upload} from "element-react";
