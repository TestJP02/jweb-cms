...
public class ClassElementProcessorImplTest {
    ...
    public void process() throws IOException {
        TemplateEngine templateEngine = new TemplateEngine().addRepository(new SingleResourceRepository(new StringResource("template/test-class.html", template())));
        Template template = templateEngine.template("template/test-class.html").orElseThrow(RuntimeException::new);
