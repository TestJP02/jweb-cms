package io.sited.page.web.web.api;
...
import io.sited.page.web.service.UserCommentNodeResponse;
import io.sited.page.web.service.UserCommentNodeService;
import io.sited.page.web.web.api.comment.CommentTreeAJAXQuery;
import io.sited.page.web.web.api.comment.CreateCommentAJAXRequest;
...
public class CommentWebController {
    ...
    @Path("/{id}/vote")
    @POST
    public void vote(@PathParam("id") String id) {
        ...
        commentWebService.toggleVote(id, voteCommentRequest);
    }
