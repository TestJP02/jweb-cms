...
export default class Tag extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                {type: "selection"},
                {
                    label: i18n.t("page.tagName"),
                    prop: "name"
                },
                {
                    label: i18n.t("page.tagPath"),
                    prop: "path"
                },
                {
                    label: i18n.t("page.totalTagged"),
                    prop: "totalTagged"
                },
                {
                    ...
                    render: function(current) {
                        return (
                            <span className="el-table__actions">
                                ...
                                <Button type="text">
                                    <Link
                                        to={{pathname: "/admin/page/tag/" + current.id + "/update"}}> {i18n.t("page.update")} </Link>
                                </Button>
                                }
    ...
    delete(data, e) {
        e.preventDefault();
        fetch("/admin/api/page/tag/batch-delete", {
            method: "POST",
