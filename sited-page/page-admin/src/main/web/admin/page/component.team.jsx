...
export default class PageTeamComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    saveGrid() {
        ...
        if (component.attributes.list[this.state.editingIndex]) {
            const grid = component.attributes.list[this.state.editingIndex];
            Object.assign(grid, this.state.editingGrid);
        } else {
            const grid = Object.assign({}, this.state.editingGrid);
            component.attributes.list.push(grid);
        }
        this.setState({
            component: component,
            editingIndex: null
                                        ...
                                        <Form.Item label={i18n.t("page.gridList")} props="limit">
                                            <div className="page-grid__list">
                                                ...
                                                {this.state.component.attributes.list &&
                                                    this.state.component.attributes.list.map((grid, index) =>
