...
import io.sited.user.admin.web.ajax.user.BatchDeleteUserAJAXRequest;
import io.sited.user.admin.web.ajax.user.ChangePasswordAJAXRequest;
import io.sited.user.admin.web.ajax.user.ChangePasswordRequest;
import io.sited.user.admin.web.ajax.user.LoginAJAXRequest;
import io.sited.user.admin.web.ajax.user.LoginAJAXResponse;
import io.sited.user.admin.web.ajax.user.UserAJAXResponse;
import io.sited.user.admin.web.ajax.user.UserCreateAJAXRequest;
import io.sited.user.admin.web.ajax.user.UserFindAJAXRequest;
import io.sited.user.admin.web.ajax.user.UserUpdateAJAXRequest;
