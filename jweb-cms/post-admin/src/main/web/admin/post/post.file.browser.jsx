...
export default class FileBrowser extends React.Component {
    ...
    uploadSuccess(file, fileList) {
        ...
        if (processed) {
            notification({
                title: i18n.t("post.uploadSuccess"),
                type: "success"
            });
            this.find(true);
                            ...
                            <Layout.Col span="12" style={{"textAlign": "left"}}>
                                <Upload
                                    ...
                                    <Button
                                        ...
                                        disabled={this.state.uploading}>{i18n.t("post.upload")}</Button>
                                </Upload>
                            </Layout.Col>
                            <Layout.Col span="12">
                                <Button onClick={() => this.cancel()}>{i18n.t("post.cancel")}</Button>
                                <Button type="primary" onClick={() => this.submit()}>{i18n.t("post.confirm")}</Button>
                            </Layout.Col>
                        </Layout.Row>
                    </Dialog.Footer>
                </Dialog>
