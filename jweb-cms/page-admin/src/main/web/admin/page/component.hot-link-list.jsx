...
export default class PageHotLinkListComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <Dialog.Body>
                        <Form ref={(form) => {
                            ...
                            <Layout.Row>
                                ...
                                <Layout.Col span="24">
                                    <Form.Item label={i18n.t("page.hotLinkListPeriod")} props="period">
                                        <Select placeholder={i18n.t("page.categorySelect")} value={this.state.component.attributes.period}
                                            ...
                                            <Select.Option key="day" label={i18n.t("page.hotLinkListPeriodDay")} value="DAY"/>
                                            <Select.Option key="week" label={i18n.t("page.hotLinkListPeriodWeek")} value="WEEK"/>
                                            <Select.Option key="month" label={i18n.t("page.hotLinkListPeriodMonth")} value="MONTH"/>
                                        </Select>
                                    </Form.Item>
                                </Layout.Col>
                                <Layout.Col span="16">
                                    <Form.Item label={i18n.t("page.hotLinkListPage")} props="page">
                                        <Input type="number" value={this.state.component.attributes.page}
                                            onChange={val => this.formChange("page", val)}/>
                                    </Form.Item>
                                </Layout.Col>
                                <Layout.Col span="16">
                                    <Form.Item label={i18n.t("page.hotLinkListLimit")} props="limit">
...
PageHotLinkListComponent.defaultProps = {
    component: {
...
PageHotLinkListComponent.propTypes = {
    component: {
