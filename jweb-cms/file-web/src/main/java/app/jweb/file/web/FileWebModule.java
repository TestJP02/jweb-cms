...
import app.jweb.file.web.service.ImageMagicImageScalar;
...
public class FileWebModule extends AbstractWebModule {
    ...
    protected void configure() {
        ...
        } else if ("java-2d-image-magick".equals(options.imageScalar)) {
            bind(ImageScalar.class).toInstance(new ImageMagicImageScalar());
        } else {
